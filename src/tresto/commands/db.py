...
def list_tests() -> None:
    ...
    for test in tests:
        test_db = TestDatabase(
            test_directory=config.project.test_directory,
...
def show(test_name: str, data_type: str = "project_inspection") -> None:
    ...
    if data_type == "project_inspection":
        ...
        console.print(f"[red]Error:[/red] Unknown data type '{data_type}'. Use: project_inspection, playwright_investigation, test_insights")
        return
