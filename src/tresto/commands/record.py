...
from tresto.core.config import get_api_key_for_provider, get_required_env_var_name, load_config
...
def record_command(
    ...
    if not description:
        description = Prompt.ask(
            "What should this test do? (Be specific about the user flow)", default="Test basic user interaction flow"
        )
