...
class TestFileHeader:
    ...
    def test_write_to_file_new_file(self) -> None:
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            content = "import os\n\ndef test_function():\n    pass"
            header.write_to_file(file_path, content)
    ...
    def test_write_to_file_replace_existing_docstring(self) -> None:
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            header.write_to_file(file_path, content_with_docstring)
            result = file_path.read_text()
    ...
    def test_write_to_file_single_quotes_docstring(self) -> None:
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            header.write_to_file(file_path, content_with_single_quotes)
            result = file_path.read_text()
    ...
    def test_round_trip_write_and_read(self) -> None:
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            original_header.write_to_file(file_path, content)
            ...
            assert "import unittest" in file_content
            assert "class MyTest" in file_content
